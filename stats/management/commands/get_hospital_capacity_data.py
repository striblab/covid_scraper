...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # self.get_csv()
        try:
            r = requests.get('https://mn.gov/covid19/assets/HospitalCapacity_HistoricCSV_tcm1148-449110.csv')
            print(r.text)

            # col_names = ["Metric", "Detail1", "Detail2", "Detail3", "Detail4", "Data Date (MM/DD/YYYY)", "GeographicLevel", "GeographicName", "Value_NUMBER", "Units", "MOST RECENT (1)", "COVID Team"]
